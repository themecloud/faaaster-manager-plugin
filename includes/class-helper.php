...
namespace Tenweb_Manager {
    ...
    class Helper
    {
        ...
        public function get_products_objects($plugins_data = array(), $themes_data = array(), $addons_data = array())
        {
        ...
        private function get_themes_objects($themes_data, $site_installed_themes)
        {
        ...
        private static function site_state($force_send = false, $current_blog_id = null)
        {
            ...
            if (!empty($state_data)) {
                ...
                $send_all_data = (!empty($state_data['plugins_info']) &&
        ...
        public static function get_site_info($blog_id = null, $reset = false)
        {
            ...
            $debug_mode = Manager::isDebugModeActive();
            $indexable = Manager::isIndexable();
